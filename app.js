        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return A._asyncAwait(A.HttpRequest_getString("https://csfoundations.cs.aalto.fi/json-data/kysymykset.json"), $async$main);
            case 2:
